...
vim.api.nvim_set_hl(0, "BufferInactiveMod", { bg = "#232831", fg = "#53524f" })
...
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", { bg = "#53524f", fg = "#ebcb8b" })
...
vim.api.nvim_set_hl(0, "TabLineSel", { bg = "#7e8188", fg = "#cdcecf" })
