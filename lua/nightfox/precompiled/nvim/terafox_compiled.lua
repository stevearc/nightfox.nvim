...
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo", { bg = "#1f363b", fg = "#5a93aa" })
...
vim.api.nvim_set_hl(0, "NotifyWARNBorder", { fg = "#896453" })
...
vim.api.nvim_set_hl(0, "TabLineSel", { bg = "#587b7b", fg = "#e6eaea" })
